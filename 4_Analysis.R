...
for (scale in c(2, 3, 4, 5, 6)) {
  ...
  #test_2 <- linearHypothesis(model_2, c("drought_primReformExpYes=drought_primReformExpNo"))
  ...
  #test_3 <- linearHypothesis(model_3, c("drought_primReformExpYes=drought_primReformExpNo"))
...
ord2 <- c("2-month drought", "3-month drought", "4-month drought", "5-month drought", "6-month drought")
